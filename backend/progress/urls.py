...
from .views import PhaseProgressDetailView, PhaseResultView, StartPhaseSessionView, PhaseMapStatusView, LevelProgressSummaryView, AllLevelProgressSummaryView, ProgressSummaryView, DashboardSummaryView, ProgressReportView, ProgressReportPdfView, PausePhaseSessionView, ResumePhaseSessionView
...
urlpatterns = [
    ...
    path('all-level-progress/', AllLevelProgressSummaryView.as_view(), name='all-level-progress'),
